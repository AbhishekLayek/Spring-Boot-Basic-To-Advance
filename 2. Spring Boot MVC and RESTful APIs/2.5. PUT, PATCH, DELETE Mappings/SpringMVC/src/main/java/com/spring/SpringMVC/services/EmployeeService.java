...
import com.spring.SpringMVC.configs.ModelMapperConfig;
import com.spring.SpringMVC.dto.EmployeeDTO;
import com.spring.SpringMVC.entities.EmployeeEntity;
import com.spring.SpringMVC.repositories.EmployeeRepository;
...
public class EmployeeService {
	...
	public EmployeeDTO updateEmployee(Integer id, EmployeeDTO inputEmpDTO) {
		if(!ISEmployeeExistsById(id)) return null;
		EmployeeEntity empEntity = modelMapper.map(inputEmpDTO, EmployeeEntity.class);
		empEntity.setId(id);
