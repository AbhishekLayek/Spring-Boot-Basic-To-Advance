...
import com.spring.APIResponse.exceptions.ResourceNotFoundException;
...
public class EmployeeService {
	...
	private boolean validateEmployeeExistance(Integer id) {
